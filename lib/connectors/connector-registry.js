...
// Idempotent registration: also self-heals after Next.js hot-reload wipes the map
// while leaving the globalThis flag set (which would otherwise leave us with 0 connectors).
if (!globalThis.__AFINITY_CONNECTORS_REGISTERED__ || connectorRegistry.list().length === 0) {
