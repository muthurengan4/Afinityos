...
export const navItems = [
  ...
  { label: 'Ask AfinityAI', href: '/ask', icon: Sparkles, group: 'main', badge: 'AI' },
  ...
  { label: 'Connectors', href: '/connectors', icon: Cable, group: 'system', badge: 'NEW' },
  { label: 'Modules', href: '/modules', icon: Boxes, group: 'system' },
  { label: 'Events', href: '/events', icon: Activity, group: 'system' },
